...
(function(){
  ...
  _.extend(Model.prototype, Events, {
    ...
    fetch: function(options) {      
      ...
      options.success = function(resp, status, xhr) {
        ...
        /* Custom changes start. Adding LocalStorage facility */
  ...
  _.extend(Collection.prototype, Events, {
    ...
    fetch: function(options) {            
      ...
      /* Custom changes start. Adding SessionStorage facility */        
      if(!_.isEmpty(SM_APP.SesStor)){          
         var resp = SM_APP.SesStor.get(collection.url());         
         if(!_.isEmpty(resp)){
      ...
      options.success = function(resp, status, xhr) {
        ...
        /* Custom changes start. Adding SessionStorage facility */        
        if(!_.isEmpty(SM_APP.SesStor)){ SM_APP.SesStor.add(collection.url(), resp); }
        /* Custom changes end. */
  ...
  Backbone.sync = function(method, model, options) {
   ...
   return Backbone.$.jsonp(_.extend(params, options)); 
   /* Custom changes. */
  };
